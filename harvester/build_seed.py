...
EXTRA_CURATED = [
    ...
    # Italian prime ministers (heads of government of unified Italy)
    ("Cavour", "Camillo Benso, Count of Cavour", "Kingdom of Italy", 1861, 1861,
     "architect of Italian unification; first prime minister", "italy"),
    ("Francesco Crispi", "Francesco Crispi", "Kingdom of Italy", 1887, 1896,
     "forceful prime minister of the new Italian state", "italy"),
    ("Giovanni Giolitti", "Giovanni Giolitti", "Kingdom of Italy", 1892, 1921,
     "dominant statesman of the liberal 'Giolittian era'", "italy"),
    ("Benito Mussolini", "Benito Mussolini", "Kingdom of Italy", 1922, 1943,
     "Fascist dictator who ruled Italy as Il Duce", "italy"),
    ("Alcide De Gasperi", "Alcide De Gasperi", "Italian Republic", 1945, 1953,
     "founding prime minister of the postwar Italian Republic", "italy"),
    ("Giulio Andreotti", "Giulio Andreotti", "Italian Republic", 1972, 1992,
     "seven-time prime minister of the First Republic", "italy"),
    ("Giovanni Spadolini", "Giovanni Spadolini", "Italian Republic", 1981, 1982,
     "first non–Christian-Democrat prime minister of the Republic", "italy"),
    ("Bettino Craxi", "Bettino Craxi", "Italian Republic", 1983, 1987,
     "Socialist prime minister of the 1980s", "italy"),
    ("Silvio Berlusconi", "Silvio Berlusconi", "Italian Republic", 1994, 2011,
     "media tycoon and four-time prime minister", "italy"),
    ("Romano Prodi", "Romano Prodi", "Italian Republic", 1996, 2008,
     "centre-left prime minister and EU Commission president", "italy"),
    ("Matteo Renzi", "Matteo Renzi", "Italian Republic", 2014, 2016,
     "young reformist prime minister", "italy"),
    ("Mario Draghi", "Mario Draghi", "Italian Republic", 2021, 2022,
     "'Super Mario'; ECB president turned prime minister", "italy"),
    ("Giorgia Meloni", "Giorgia Meloni", "Italian Republic", 2022, 2026,
     "Italy's first woman prime minister", "italy"),
    # German chancellors (and an Austrian one)
    ("Klemens von Metternich", "Klemens von Metternich", "Austrian Empire", 1821, 1848,
     "architect of the post-Napoleonic European order", "germany"),
    ("Otto von Bismarck", "Otto von Bismarck", "German Empire", 1871, 1890,
     "the Iron Chancellor who unified Germany", "germany"),
    ("Adolf Hitler", "Adolf Hitler", "Nazi Germany", 1933, 1945,
     "dictator of Nazi Germany", "germany"),
    ("Konrad Adenauer", "Konrad Adenauer", "West Germany", 1949, 1963,
     "first chancellor of West Germany", "germany"),
    ("Ludwig Erhard", "Ludwig Erhard", "West Germany", 1963, 1966,
     "father of the postwar 'economic miracle'", "germany"),
    ("Willy Brandt", "Willy Brandt", "West Germany", 1969, 1974,
     "chancellor of Ostpolitik and reconciliation", "germany"),
    ("Helmut Schmidt", "Helmut Schmidt", "West Germany", 1974, 1982,
     "crisis-steering Social Democratic chancellor", "germany"),
    ("Helmut Kohl", "Helmut Kohl", "Germany", 1982, 1998,
     "chancellor of German reunification", "germany"),
    ("Gerhard Schröder", "Gerhard Schröder", "Germany", 1998, 2005,
     "Social Democratic chancellor of the reform years", "germany"),
    ("Angela Merkel", "Angela Merkel", "Germany", 2005, 2021,
     "long-serving chancellor; de facto leader of Europe", "germany"),
    ("Olaf Scholz", "Olaf Scholz", "Germany", 2021, 2025,
     "chancellor through the energy crisis and war in Ukraine", "germany"),
]
